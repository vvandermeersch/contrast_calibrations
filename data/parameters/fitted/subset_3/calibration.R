...
# Working directory
wd <- "/scratch/vvandermeersch/phenofit_calibration_4"
...
folders=list(wd=wd, 
             climate="/scratch/vvandermeersch/data/climate/phenofit_format/ERA5Land_fagsyl/1000pres_1000abs/subset_3")
...
# Donnees occurrence
load("/scratch/vvandermeersch/data/species/fagsyl/1000pres_1000abs/occurrence_subset_3.Rdata")
...
for(i in 5:rep){
	...
	custom_index <- paste0("subset3_rep", i)
